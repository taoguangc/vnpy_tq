"""STRAT_RO13_EXP003 — H_EDGE temporal OOS for STRAT_REV_OPP13_01@0.1.0（rb/2025）.

Delegation-25AQ Observation. Identical gates to EXP002; year is the OOS dimension.
...
EXPERIMENT_ID = "STRAT_RO13_EXP003"
EXPECTED_SOURCE_HASH = (
    "d20147d23918edac9d94cdea5572155dacc8375218b62c0aa4a822eac303d1de"
)
EXPECTED_PARAMETER_HASH = (
    "1f95584dfc3a17c18ad41210a53e53fbe050988850d656f881686d80e7c11405"
)
BINDING_PATHS = [
...
def main() -> int:
    ...
    engine.add_strategy(StratRevOpp1301Strategy, {})
    ...
    meta = {
        ...
        "authorization": "Delegation-25AQ Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_RO13_EXP002",
        "symbol": "rb",
        "period": "2025",
