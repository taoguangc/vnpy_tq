"""STRAT_TO08_EXP003 — H_EDGE temporal OOS for STRAT_TREND_OPP08_01@0.1.0（rb/2025）.

Delegation-25AC Observation. Identical gates to EXP002; year is the OOS dimension.
...
EXPERIMENT_ID = "STRAT_TO08_EXP003"
EXPECTED_SOURCE_HASH = (
    "0a6023e581b8547d42c10a30f05324f0c841d131cbbd748ade4ad7476fd66f14"
)
EXPECTED_PARAMETER_HASH = (
    "5c48a70f7666d033d340799e4fdf19972aeadfc15c98b068f85521ab32d0163e"
)
BINDING_PATHS = [
...
def main() -> int:
    ...
    engine.add_strategy(StratTrendOpp0801Strategy, {})
    ...
    meta = {
        ...
        "authorization": "Delegation-25AC Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_TO08_EXP002",
        "symbol": "rb",
        "period": "2025",
