"""STRAT_RO16_EXP001 — H_MECH first Testing EXP for STRAT_REV_OPP16_01@0.1.0.
...
EXPERIMENT_ID = "STRAT_RO16_EXP001"
EXPECTED_SOURCE_HASH = (
    "f87cdcc43e74060f23c08fa06364f0be90c538a1576566a0034ba096f0adc220"
)
...
def main() -> int:
    ...
    engine.add_strategy(StratRevOpp1601Strategy, {})
    ...
    meta = {
        ...
        "authorization": "Authorize Offline Observation for STRAT_RO16_EXP001（required at run）",
