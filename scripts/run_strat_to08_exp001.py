"""STRAT_TO08_EXP001 — H_MECH smoke for STRAT_TREND_OPP08_01@0.1.0.

PRE-REGISTERED under SEVF Fill. Authorization: Delegation-25AA.
...
EXPERIMENT_ID = "STRAT_TO08_EXP001"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25AA（Authorize Offline Observation for STRAT_TO08_EXP001）",
