"""STRAT_TO02_EXP002 — H_EDGE diagnostic for STRAT_TREND_OPP02_01@0.1.0（rb/2024）.

Delegation-25AK Observation. Gate template = CID_004/005 EXP002 A/B.
...
EXPERIMENT_ID = "STRAT_TO02_EXP002"
...
def main() -> int:
    ...
    meta = {
        ...
        "parent_experiment": "STRAT_TO02_EXP001",
        "symbol": "rb",
        "period": "2024",
        "outcome": outcome,
