"""STRAT_SO19_EXP003 — H_EDGE temporal OOS for STRAT_SESS_OPP19_01@0.1.0（rb/2025）.

Delegation-25AH Observation. Identical gates to EXP002; year is the OOS dimension.
≠ Alpha rescue · ≠ parameter retune · ≠ rewrite EXP001/002 · ≠ OD_REV.
"""
...
EXPERIMENT_ID = "STRAT_SO19_EXP003"
EXPECTED_SOURCE_HASH = (
    "f7cbcb3f9b556af5478d7f88fa9d7f51627887250273b4bd4c153e38e43d90d6"
)
EXPECTED_PARAMETER_HASH = (
    "3f9793feda3d0ca20ba238197acbf120a469a486620b0f23a002dcceb5762a05"
)
BINDING_PATHS = [
...
def main() -> int:
    ...
    engine.add_strategy(StratSessOpp1901Strategy, {})
    ...
    meta = {
        ...
        "authorization": "Delegation-25AH Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_SO19_EXP002",
        "symbol": "rb",
        "period": "2025",
        "sample_purpose": "temporal_oos_same_gates",
        "outcome": outcome,
