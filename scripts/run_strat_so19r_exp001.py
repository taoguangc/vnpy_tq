"""STRAT_SO19R_EXP001 — H_MECH smoke for STRAT_SESS_OPP19_REV_01@0.1.0.

PRE-REGISTERED under SEVF Fill. Authorization: Delegation-25AS.
≠ Alpha · ≠ H_EDGE · ≠ Bindable · ≠ parameter search · ≠ OD_REV.
"""
...
EXPERIMENT_ID = "STRAT_SO19R_EXP001"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25AS（Authorize Offline Observation for STRAT_SO19R_EXP001）",
