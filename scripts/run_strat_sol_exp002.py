"""STRAT_SOL_EXP002 — H_EDGE for STRAT_SMC_OB_LONG_01@0.1.0（rb/2024）.

Delegation-25BE Observation. Gate template = prior CID H_EDGE A/B.
Parent: STRAT_SOL_EXP001.
...
from strategies.paaf.strat_smc_ob_long_01 import StratSmcObLong01Strategy

EXPERIMENT_ID = "STRAT_SOL_EXP002"
EXPECTED_SOURCE_HASH = (
    "a835a8bb8c1dfa6a18e610e323351cd4620070ce1b8ac4f410e72c5de833d42d"
)
EXPECTED_PARAMETER_HASH = (
    "8ea775b14b6f4a44eaaf494aa39aa650f6da4d44ff408e3dedb6f762a4e06214"
)
BINDING_PATHS = [
    "strategies/paaf/detectors/smc_order_block_long.py",
    "strategies/paaf/strat_smc_ob_long_01.py",
]
DETECTOR_BINDING = "SMC_OB_LONG@1.0.0"
FREEZE_ID = "SIF_CID_013_V0_1"
...
def main():
    ...
    engine.add_strategy(StratSmcObLong01Strategy, {})
    ...
    with audit_csv.open("w", newline="", encoding="utf-8") as fh:
        fields = [
            "exit_reason", "mfe_ticks", "mae_ticks", "holding_minutes",
