"""STRAT_RO17_EXP001 — H_MECH smoke for STRAT_REV_OPP17_01@0.1.0.

PRE-REGISTERED under SEVF Fill. Authorization: Delegation-25U.
...
EXPERIMENT_ID = "STRAT_RO17_EXP001"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25U（Authorize Offline Observation for STRAT_RO17_EXP001）",
