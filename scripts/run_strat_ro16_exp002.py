"""STRAT_RO16_EXP002 — H_MECH smoke for STRAT_REV_OPP16_01@0.1.1.
...
EXPERIMENT_ID = "STRAT_RO16_EXP002"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Authorize Offline Observation for STRAT_RO16_EXP002（required at run）",
        "hypothesis_family": "H_MECH",
        "not_hypothesis": ["H_EDGE", "H_ALPHA", "H_NULL"],
        "parent_experiment": "STRAT_RO16_EXP001",
        "parent_outcome": "HOLD",
        "symbol": "rb",
        "period": "2024",
        "outcome": outcome,
