"""STRAT_BS02_EXP010 — H_CAPITAL_GATE multi-symbol portability for @0.2.0.

Universe predeclared: {rb, i, MA} · 2024 · capital=200_000.
Closes BPR gap G6 if all symbols avoid capital≤0 under @0.2.0 controls.
...
EXPERIMENT_ID = "STRAT_BS02_EXP010"
...
def main() -> int:
    ...
    if any(o == "REVERT" for o in outcomes):
        ...
        bundle_outcome = "KEEP"
        bundle_reason = "all symbols {rb,i,MA} avoided capital<=0 under @0.2.0"
    else:
        bundle_outcome = "HOLD"
