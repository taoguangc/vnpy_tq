"""STRAT_TO02_EXP003 — H_EDGE temporal OOS for STRAT_TREND_OPP02_01@0.1.0（rb/2025）.

Delegation-25AK Observation. Identical gates to EXP002; year is the OOS dimension.
...
EXPERIMENT_ID = "STRAT_TO02_EXP003"
EXPECTED_SOURCE_HASH = (
    "c6e47760e11290b171aec8d50c7f727606ed5df147ecb6eaa3b660fa62de9f99"
)
EXPECTED_PARAMETER_HASH = (
    "06b64730fa61b0b1c9411feb332140d5a7b4911339c035ac30f0ede406db7a86"
)
BINDING_PATHS = [
...
def main() -> int:
    ...
    engine.add_strategy(StratTrendOpp0201Strategy, {})
    ...
    meta = {
        ...
        "authorization": "Delegation-25AK Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_TO02_EXP002",
        "symbol": "rb",
        "period": "2025",
