"""STRAT_SO19_EXP002 — H_EDGE diagnostic for STRAT_SESS_OPP19_01@0.1.0（rb/2024）.

Delegation-25AG Observation. Gate template = prior CID EXP002 A/B.
≠ Alpha Candidate · ≠ parameter search · ≠ rewrite EXP001 · ≠ OD_REV.
"""
...
EXPERIMENT_ID = "STRAT_SO19_EXP002"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25AG Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_SO19_EXP001",
        "symbol": "rb",
        "period": "2024",
        "outcome": outcome,
