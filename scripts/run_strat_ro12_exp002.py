"""STRAT_RO12_EXP002 — H_EDGE diagnostic for STRAT_REV_OPP12_01@0.1.0（rb/2024）.

Delegation-25Q Observation. Gate template = CID_002 EXP013 / CID_003 EXP003 A/B.
...
EXPERIMENT_ID = "STRAT_RO12_EXP002"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25Q Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_RO12_EXP001",
        "symbol": "rb",
        "period": "2024",
        "outcome": outcome,
