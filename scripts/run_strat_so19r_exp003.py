"""STRAT_SO19R_EXP003 — H_EDGE temporal OOS for STRAT_SESS_OPP19_REV_01@0.1.0（rb/2025）.

Delegation-25AT Observation. Identical gates to EXP002; year is the OOS dimension.
...
EXPERIMENT_ID = "STRAT_SO19R_EXP003"
EXPECTED_SOURCE_HASH = (
    "731c908d810d6c5f61400ceaeb06beb37a8436bc2f8503261ba2fecd86060593"
)
EXPECTED_PARAMETER_HASH = (
    "2f8f2170dc94cfa63ac9e99bfd365d239be4c4186672c5db54143ae0d21b8f71"
)
BINDING_PATHS = [
...
def main() -> int:
    ...
    engine.add_strategy(StratSessOpp19Rev01Strategy, {})
    ...
    meta = {
        ...
        "authorization": "Delegation-25AT Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_SO19R_EXP002",
        "symbol": "rb",
        "period": "2025",
