"""CTX_CID003_EXP001 — H_CTX_FILTER Observation（B0 vs B1）.
...
def main() -> int:
    ...
    rows1, denials, meta1 = _run(Opp16CtxFilterV011)
    ...
    run_meta = {
        ...
        "authorization": "Delegation-50E（Authorize Context Consumer Observation under path lock）",
