"""STRAT_RO13DT_EXP004 — H_EDGE OOS for STRAT_REV_OPP13_DT_01@0.1.0（rb/2025）.

Delegation-25AX Observation. Same gates as EXP003. Parent EXP003 HOLD.
...
EXPERIMENT_ID = "STRAT_RO13DT_EXP004"
...
def main() -> int:
    ...
    meta = {
        ...
        "parent_experiment": "STRAT_RO13DT_EXP003",
        "symbol": "rb",
        "period": "2025",
        "outcome": outcome,
