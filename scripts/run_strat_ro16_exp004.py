"""STRAT_RO16_EXP004 — H_EDGE temporal OOS for STRAT_REV_OPP16_01@0.1.1（rb/2025）.

Delegation-20 Observation authorized. Gate template = CID_002 EXP013 A/B.
≠ Alpha Candidate · ≠ parameter search · ≠ rewrite EXP001/002.
"""
...
EXPERIMENT_ID = "STRAT_RO16_EXP004"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-20 Observation（授权你决定20次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_RO16_EXP003",
        "symbol": "rb",
        "period": "2025",
        "outcome": outcome,
