"""STRAT_RO12_EXP003 — H_EDGE temporal OOS for STRAT_REV_OPP12_01@0.1.0（rb/2025）.

Identical gates to EXP002; year is the OOS dimension.
...
EXPERIMENT_ID = "STRAT_RO12_EXP003"
EXPECTED_SOURCE_HASH = (
    "2efd2112a7ffd6eae70ac2761c0ba3559a07a3e0f6ef7f13ae4e35caba42de4d"
)
EXPECTED_PARAMETER_HASH = (
    "b6c767a8bf8afde7e5bba56a2777a036ab21f06b7b807ec630d9bd6edb9e1418"
)
BINDING_PATHS = [
...
def main() -> int:
    ...
    engine.add_strategy(StratRevOpp1201Strategy, {})
    ...
    if n_gate < MIN_N:
        ...
        outcome, reason = "KEEP", "structure_A and expectancy_B both PASS（OOS）"
    else:
        outcome, reason = "REVERT", (
            f"OOS structure_ok={structure_ok} expectancy_ok={expectancy_ok} "
    ...
    meta = {
        ...
        "authorization": "Delegation-25Q Observation（H_EDGE OOS）",
        "hypothesis_family": "H_EDGE",
        "oos_of": "STRAT_RO12_EXP002",
        "parent_experiment": "STRAT_RO12_EXP002",
        "symbol": "rb",
        "period": "2025",
        "outcome": outcome,
