"""STRAT_TO08_EXP002 — H_EDGE diagnostic for STRAT_TREND_OPP08_01@0.1.0（rb/2024）.

Delegation-25AB Observation. Gate template = CID_004/005 EXP002 A/B.
...
EXPERIMENT_ID = "STRAT_TO08_EXP002"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25AB Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_TO08_EXP001",
        "symbol": "rb",
        "period": "2024",
        "outcome": outcome,
