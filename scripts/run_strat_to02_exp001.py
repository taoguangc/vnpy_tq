"""STRAT_TO02_EXP001 — H_MECH smoke for STRAT_TREND_OPP02_01@0.1.0.

PRE-REGISTERED under SEVF Fill. Authorization: Delegation-25AJ.
...
EXPERIMENT_ID = "STRAT_TO02_EXP001"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25AJ（Authorize Offline Observation for STRAT_TO02_EXP001）",
