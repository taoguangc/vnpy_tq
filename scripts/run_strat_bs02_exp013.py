"""STRAT_BS02_EXP013 — H_EDGE diagnostic for @0.1.1（rb/2024）.

PRE-REGISTERED under Authorize SEVF Fill.
Do NOT run unless Observation is separately authorized.

≠ Alpha Candidate · ≠ RISK surface · ≠ parameter search.
"""
...
EXPERIMENT_ID = "STRAT_BS02_EXP013"
...
def main() -> int:
    ...
    meta = {
        ...
        "not_hypothesis": ["H_MECH", "H_CAPITAL_GATE", "H_ALPHA_VERIFIED"],
        "outcome": outcome,
