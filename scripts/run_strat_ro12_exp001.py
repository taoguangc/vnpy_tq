"""STRAT_RO12_EXP001 — H_MECH smoke for STRAT_REV_OPP12_01@0.1.0.

PRE-REGISTERED under SEVF Fill. Authorization: Delegation-25P.
...
EXPERIMENT_ID = "STRAT_RO12_EXP001"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25P（Authorize Offline Observation for STRAT_RO12_EXP001）",
