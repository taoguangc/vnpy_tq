"""STRAT_SO19_EXP001 — H_MECH smoke for STRAT_SESS_OPP19_01@0.1.0.

PRE-REGISTERED under SEVF Fill. Authorization: Delegation-25AF.
...
EXPERIMENT_ID = "STRAT_SO19_EXP001"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25AF（Authorize Offline Observation for STRAT_SO19_EXP001）",
