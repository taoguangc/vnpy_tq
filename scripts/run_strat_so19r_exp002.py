"""STRAT_SO19R_EXP002 — H_EDGE diagnostic for STRAT_SESS_OPP19_REV_01@0.1.0（rb/2024）.

Delegation-25AT Observation. Gate template = CID_004/005 EXP002 A/B.
≠ Alpha Candidate · ≠ parameter search · ≠ rewrite EXP001.
"""
...
EXPERIMENT_ID = "STRAT_SO19R_EXP002"
...
def main() -> int:
    ...
    meta = {
        ...
        "parent_experiment": "STRAT_SO19R_EXP001",
        "symbol": "rb",
        "period": "2024",
        "outcome": outcome,
