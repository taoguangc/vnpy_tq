"""STRAT_RO17_EXP004 — H_EDGE temporal OOS for STRAT_REV_OPP17_01@0.1.0（rb/2025）.

Delegation-25X Observation. Identical gates to EXP002/003; year is the OOS dimension.
≠ Alpha rescue · ≠ parameter retune · ≠ rewrite EXP001/002/003.
"""
...
EXPERIMENT_ID = "STRAT_RO17_EXP004"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25X Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_RO17_EXP003",
        "symbol": "rb",
        "period": "2025",
