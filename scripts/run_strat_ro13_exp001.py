"""STRAT_RO13_EXP001 — H_MECH smoke for STRAT_REV_OPP13_01@0.1.0.

PRE-REGISTERED under SEVF Fill. Authorization: Delegation-25AP.
...
EXPERIMENT_ID = "STRAT_RO13_EXP001"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25AP（Authorize Offline Observation for STRAT_RO13_EXP001）",
