"""STRAT_RO15_EXP003 — H_EDGE temporal OOS for STRAT_REV_OPP15_01@0.1.0（rb/2025）.

Delegation-25AN Observation. Identical gates to EXP002; year is the OOS dimension.
...
EXPERIMENT_ID = "STRAT_RO15_EXP003"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25AN Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_RO15_EXP002",
        "symbol": "rb",
        "period": "2025",
