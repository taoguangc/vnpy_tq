"""STRAT_SZL_EXP003 — H_EDGE for STRAT_SMC_ZSCORE_LONG_01@0.1.0（rb/2025）.

Delegation-25BH Observation. Gate template = prior CID H_EDGE A/B.
Parent: STRAT_SZL_EXP002.
...
EXPERIMENT_ID = "STRAT_SZL_EXP003"
...
def main():
    ...
    meta = {
        ...
        "parent_experiment": "STRAT_SZL_EXP002",
        "symbol": "rb", "period": "2025",
