"""STRAT_RO17_EXP002 — H_EDGE diagnostic for STRAT_REV_OPP17_01@0.1.0（rb/2024）.

Delegation-25V Observation. Gate template = CID_004 EXP002 A/B.
...
EXPERIMENT_ID = "STRAT_RO17_EXP002"
...
def main() -> int:
    ...
    meta = {
        ...
        "authorization": "Delegation-25V Observation（授权你决定25次）",
        "hypothesis_family": "H_EDGE",
        "not_hypothesis": ["H_MECH", "H_ALPHA_CANDIDATE", "H_ALPHA_VERIFIED"],
        "parent_experiment": "STRAT_RO17_EXP001",
        "symbol": "rb",
        "period": "2024",
        "outcome": outcome,
