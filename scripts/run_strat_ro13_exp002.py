"""STRAT_RO13_EXP002 — H_EDGE diagnostic for STRAT_REV_OPP13_01@0.1.0（rb/2024）.

Delegation-25AQ Observation. Gate template = CID_004/005 EXP002 A/B.
...
EXPERIMENT_ID = "STRAT_RO13_EXP002"
...
def main() -> int:
    ...
    meta = {
        ...
        "parent_experiment": "STRAT_RO13_EXP001",
        "symbol": "rb",
        "period": "2024",
        "outcome": outcome,
