"""STRAT_TREND_OPP08_01@0.1.0 — PAAF orchestration for OPP08 strong-breakout.

CID_006 · Candidate Identity Freeze target.
Strategy only orchestrates: Context → OPP08 Detector → levels → Execution → log.
Morphology lives in OPP08StrongBreakoutDetector.
...
from strategies.paaf.detectors.opp08_strong_breakout import (
    DEFAULT_ATR_PERIOD,
    DEFAULT_EMA_PERIOD,
    DEFAULT_STRONG_BAR_ATR_MULT,
    DEFAULT_STRONG_BAR_BODY_RATIO,
    OPP08StrongBreakoutDetector,
)
...
class StratTrendOpp0801Strategy(CtaTemplate):
    """CID_006 orchestrator v0.1.0 — no pattern logic inlined."""
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        ...
        self.detector = OPP08StrongBreakoutDetector(
    ...
    def on_init(self) -> None:
        self.write_log(
            ...
            f"(CID_006; detector=OPP08@1.0.0; signal=5m; risk=1m)"
        )
        self.load_bar(30)
