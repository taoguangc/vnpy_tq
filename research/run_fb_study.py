# -*- coding: utf-8
"""EXP-008 — Failed Breakout 多周期 Event Study（非救 1m）。

用法::
  python -m research.run_fb_study --symbol rb
  python -m research.run_fb_study --symbol rb --start 2024-01-01 --end 2025-06-30
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="EXP-008 Failed Breakout Timeframe Study")
    ...
    parser.add_argument("--timeframes", default="3,5,10,15,30")
