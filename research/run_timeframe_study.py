# -*- coding: utf-8
"""EXP-006A — First Pullback 多周期对照。

用法::
  python -m research.run_timeframe_study --symbol rb
  python -m research.run_timeframe_study --symbol rb --start 2024-01-01 --end 2025-06-30
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="EXP-006A Timeframe Selection (First Pullback)")
    parser.add_argument("--setup", default="first_pullback", help="default: first_pullback / S2")
    ...
    parser.add_argument(
        ...
        help="comma-separated minutes, e.g. 3,5,10,15,30",
    )
