...
| — | `docs/development/PLATFORM_CONSTRUCTION_PHASE.md` | 平台建设阶段定位与开发纪律 |
| — | `docs/development/REVIEW_CHECKLIST.md` | Pre-Merge 三问（Decision / Contract / Baseline） |
| — | `docs/research/PAAF_RESEARCH_METHOD.md` | **PRM v1.0** — PAAF Scientific Method（Epoch 1 研究体系起点） |
